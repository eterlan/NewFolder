...
public partial class ConfigContext {
    ...
    public ConfigEntity SetWeaponConfigs(ECS.Config.WeaponConfigs newValue) {
        if (hasWeaponConfigs) {
        ...
        entity.AddWeaponConfigs(newValue);
        return entity;
    }

    public void ReplaceWeaponConfigs(ECS.Config.WeaponConfigs newValue) {
        var entity = weaponConfigsEntity;
        if (entity == null) {
            entity = SetWeaponConfigs(newValue);
        } else {
            entity.ReplaceWeaponConfigs(newValue);
        }
    }
...
public partial class ConfigEntity {
    ...
    public void AddWeaponConfigs(ECS.Config.WeaponConfigs newValue) {
